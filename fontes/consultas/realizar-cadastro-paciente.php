...
<section id="realizar-cadastro-paciente">
<br />
<br />
<br />
<h1><p class="serif text-primary">Realizar Cadastro do Paciente</p></h1>
<form action="index.php?page=salvar-cadastro-paciente&acao=cadastrar" method="POST">
