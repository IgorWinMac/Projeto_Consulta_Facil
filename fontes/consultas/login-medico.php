...
$usuario      = $_REQUEST['nome_usumedico'];
$senha        = $_REQUEST['senha'];

$sql = "SELECT * FROM usumedico WHERE nome_usumedico = '$usuario' AND senha = '$senha' ";
...
$qtd = $resultado->num_rows;
	...
	if($qtd == 0){
		...
		$_SESSION['nome_usumedico'] = $usuario;
		$_SESSION['senha']   = $senha;
		
		header("Location: area-medico.php");
	}
}
...
<div class="container">
<h1><p class="serif text-primary">Área do Médico</p></h1> 
